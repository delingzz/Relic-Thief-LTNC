...
public class Manager {
    //chiều dài và rộng của toàn map
    ...
    //danh sách luu trữ các bot có trong map
    private ArrayList<Bot> bot = new ArrayList<>();
    private TileMap map;
    //mảng lưu item trên map
    private ArrayList<Item> items = new ArrayList<>();
    //mảng lưu bom trên map
    ...
    //mảng lưu danh sách các điểm có thể spawn
    ...
    public void update(double dt) {
        ...
        while (exploreIt.hasNext()) {
            ...
            explore.animation(dt, player, bot, map);
    ...
    public void start(String name) {
        ...
        gamePane.getChildren().addAll(player.getSprite(), player.getNameText());
    ...
    //continue sau khi da thoat game
